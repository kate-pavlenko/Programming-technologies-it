...
#### 11. На встановленому Ubuntu завантажила makefile, який, у свою чергу, встановив пайтон, pipenv та інші директиви. Після цього створено ізольоване середовище, виконані усі тести, а також закомічено файл mk- дії успішно завершені.